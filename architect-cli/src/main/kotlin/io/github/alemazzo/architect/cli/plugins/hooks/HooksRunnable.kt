...
import io.github.alemazzo.architect.cli.plugins.hooks.application.HooksInitTaskTask
...
@Singleton
@CommandLine.Command(
	name = HooksRunnable.name,
	description = ["Run the hooks command"],
	subcommands = [
		HooksInitTaskTask::class,
...
class HooksRunnable : PluginCommand<PipelinesContextHolder>(name) {
	companion object {
